document.addEventListener("DOMContentLoaded", function () {
    ...
    async function createOrder(userData) {
        try {
            const response = await fetch("http://infest-2k25-registration-page.railway.internal/create-order", {
                method: "POST",
    ...
    async function completeRegistration(userData, paymentId = null) {
        ...
        try {
            const response = await fetch("http://infest-2k25-registration-page.railway.internal/register", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
    ...
    submitButton.addEventListener("click", async function (event) {
        ...
        try {
            ...
            const registrationResponse = await fetch("http://infest-2k25-registration-page.railway.internal/register", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify(userData)
            });
            ...
            if (registrationResult.status === "success") {
                ...
                const paymentResponse = await fetch("http://infest-2k25-registration-page.railway.internal/create-payment-order", {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
